...
public:
     ...
     */
    std::vector<std::string_view> GetKmers() const;
     ...
     */
    std::vector<std::string_view> GetKmersMinusOneMers();
     ...
     */
    std::unordered_set<std::string_view> GetUniqueKMinusOneMers();

private:
    const int k_mer_size_;                   ///< The size of the k-mers to be generated.
    std::vector<std::string_view> kmer_vec_; ///< A vector of the k-mers generated by the KMerifier object.
};